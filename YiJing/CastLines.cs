...
namespace YiJing
{
    class CastLines
    {
        ...
        public static Stack<string> yarrowStalks()
        {
            ...
            {
                Console.WriteLine($"\n\n\t\t*** CREATING LINE NUMBER {line+1} of 6 ***");
                ...
                Console.WriteLine($"\n{yarrowPile[removeIndex]} is taken out of the pile.");
                ...
                Console.WriteLine("\nThe stalks have been combined into two piles.");
                ...
                Console.WriteLine("\nThe pile has been split into two piles.");
